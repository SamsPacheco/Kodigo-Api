...
export const ModalDetalleReservaciones = ({
          ...
          <div className="modal-content">
            <div className="modal-header">
              ...
              <button
                type="button"
                className="btn-close"
                onClick={cerrarModalDetalleReservaciones}
              ></button>
            </div>
            ...
            <div className="modal-body">
              ...
              <div className="bg-light rounded p-2">
                ...
                <br />
                <span className="bi-moon-stars"> {noches} noches</span>
              </div>
            </div>
            ...
            <div className="modal-footer">
              <button
                ...
                onClick={()=>onCancelarReserva(datos.id)}
                disabled={datos.estado==="CANCELLED"}
              >
