...
export const Sidebar = () => {
  ...
  return (
    ...
    <section style={{backgroundColor: 'var(--sidebar-bg)' }} className='p-2'>
      <i className={`${ isActive ? 'bi bi-x-lg fs-2' : 'bi bi-list fs-1'} d-lg-none`} role='button' onClick={() => isActive ? setIsActive(false) : setIsActive(true)}></i>
      <section className={`flex-column p-3 ${ isActive ? 'd-block' : 'd-none'} d-lg-flex`} style={{ width: '250px', height: '98dvh'}}>
